...
%%% TAU_ISO
tau_bar = g12*b_bar;
tau_iso = tau_bar - 1/2*(tau_bar(1,1)+tau_bar(2,2)).*Id2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tr_tau_bar = tau_bar(1,1) +tau_bar(2,2);
    ...
    for j=1:2
        for k=1:2
            for l=1:2
                ...
                Jc_iso_tensor(i,j,k,l) = 2/2*(tr_tau_bar)*IIP(i,j,k,l) - 2/2*(tau_iso(i,j)*Id2(k,l) +Id2(i,j)*tau_iso(k,l));
