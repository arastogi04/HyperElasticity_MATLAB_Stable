...
%         [cons_tangent_voigt,cauchy_sigma_voigt,cauchy_sigma,J_tilde, p_tilde, dPsi_vol_dJ_tilde, d2Psi_vol_dJ_tilde2]=mate03d_vol_iso(F,det_F,d,J_tilde,p_tilde,debug,file01);
 [cons_tangent_voigt,cauchy_sigma_voigt,cauchy_sigma,J_tilde, p_tilde, dPsi_vol_dJ_tilde, d2Psi_vol_dJ_tilde2]=mate03d_vol_iso_no_growth(F,det_F,d,J_tilde,p_tilde,debug,file01);
